<%@page pageEncoding="utf-8" %>
     ...
     <div id="main">
        ...
        <div class="mt25">
            <h3>가입인증</h3>
            <small class="text-muted">회원으로 가입하는 방법에는 2가지 방법이 있습니다. 아래의 원하는 방법을 선택해주세요.<br>
            입력하신 정보는 가입완료전까지 본 사이트에 저장되지 않습니다.</small>
            <hr>
            <form>
                        ...
                        <div class="row">
                            ...
                            <div class="col-5">
                                <div class="form-group row">
                                    <label for="name" class="col-form-label col-4">이름</label>
                                    <input type="text" name="name" id="name" class="form-control col-6">
                                </div><!--이름-->
                                
                                <div class="form-group row">
                                    <label for="byear" class="col-form-label col-4">생년월일</label>
                            ...
                            <button type="button" id="cancelbtn"
                                ...
                                <i class="fa fa-remove"></i>취소하기</button>
                        </div>
                        </div>
                    </form>
                </div>
