...
public class JoinController {
    ...
    // joinme -> controller -> joinok (정보입력완료, captcah 체크ok)
    // joinme -> controller -> joinme (정보입력완료, captcah 체크no)
    ...
    public void checkuid(String uid, HttpServletResponse res){
        ...
        //아이디 중복체크 여부 결과(0=중복아님, 사용 가능 / 1=중복, 사용 불가)를
    ...
    public void findZipcode(String dong, HttpServletResponse res){
        ...
        try {
            // 응답결과를 JSON으로 설정하고 한글인코딩은 UTF-8로 지정 MIME type 지정
